                ...
                $tgl = date("Y-m-d");
                    ...
                    foreach($periksa as $pes){
                        ...
                        if($pes['interval_tgl']==1){ 
                            echo "<div style='padding:5px' style='width:50px' ><span class='glyphicon glyphicon-info-sign'></span> Member <a style='color:red'>" .$nama."</a>, Besok adalah Batas pengembalian pes </div>"; 
                        } elseif ($pes['interval_tgl']==2) {
                             echo "<div style='padding:5px' style='width:50px' ><span class='glyphicon glyphicon-info-sign'></span> Member <a style='color:red'>" .$nama."</a> Batas pengembalian pes tinggal 2 hari </div>"; 
                        } elseif ($pes['interval_tgl']==3) {
                             echo "<div style='padding:5px' style='width:50px' ><span class='glyphicon glyphicon-info-sign'></span> Member <a style='color:red'>" .$nama."</a> Batas pengembalian pes tinggal 3 hari </div>"; 
                        } elseif ($pes['interval_tgl']==0) {
                             echo "<div style='padding:5px' style='width:50px' ><span class='glyphicon glyphicon-info-sign'></span> Member <a style='color:red'>" .$nama."</a> Hari ini adalah batas pengembalian pes </div>"; 
                        } elseif ($pes['interval_tgl']<0) {
                             echo "<div style='padding:5px' style='width:50px' ><span class='glyphicon glyphicon-info-sign'></span> Member <a style='color:red'>" .$nama."</a> Telah melewati batas pengembalian pes </div>"; 
                        } else {
                            echo "";
                        }
                    }
